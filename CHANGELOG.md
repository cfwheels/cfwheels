...
* Enables the `rel` attribute for `stylesheetlinkTag()` [Michael Diederich]
* Returning a `NULL` value from a query with NULL support enabled no longer throws an error [Michael Diederich]
