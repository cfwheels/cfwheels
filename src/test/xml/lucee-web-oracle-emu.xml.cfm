<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration salt="915C5EAA-3D36-4D59-BB7226C03FD2A526" version="4.5">
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
		<data-source allow="511" blob="false" class="org.h2.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="" database="" dsn="jdbc:h2:mem:oracle-emu-test;MODE=Oracle" host="" metaCacheTimeout="60000" name="wheelstestdb" password="" port="-1" username="sa"/>
	</data-sources>
