...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
		<data-source allow="511" blob="false" class="org.postgresql.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="" database="" dsn="jdbc:postgresql:test" host="" metaCacheTimeout="60000" name="wheelstestdb" password="" port="-1" username="postgres"/>
	</data-sources>
