...
<cffunction name="pageTitle">
	...
	<cfif isDefined("page_title")>
		<cfset local.str = page_title>
	<cfelseif isDefined("request.params.action")>
		<cfset local.str = request.params.action>
	<cfelse>
		<cfset local.str = "Free online karaoke community">
	</cfif>
	<cfreturn local.str>
</cffunction>
