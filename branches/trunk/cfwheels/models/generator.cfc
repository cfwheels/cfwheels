...
<cgcomponent displayname="_#variables.model._modelName#" extends="cfwheels.models._model" hint="Creates a 'dao' type of model for single-record models">
	...
	<!--- Borrowed from Doug Hughes's Reactor --->
	<cffunction name="getCfDataType" access="private" hint="I translate the database type names into ColdFusion data type names" output="false" returntype="string">
		<cfargument name="typeName" hint="I am the type name to translate" required="yes" type="string" />
		...
		<cfswitch expression="#arguments.typeName#">
			...
			<cfcase value="char,varchar,tinytext,text,mediumtext,longtext,nvarchar,nchar,ntext,uniqueidentifier,time,enum,set">
				<cfreturn "string" />
			</cfcase>
