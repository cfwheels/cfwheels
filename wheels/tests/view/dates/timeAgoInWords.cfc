<cfcomponent extends="wheelsMapping.test">
	...
	<cfset global.args.toTime = global.now>

	<cffunction name="test_with_seconds_below_5_seconds">
		<cfset loc.c = 5 - 1>
		<cfset loc.args.fromTime = dateadd('s', -loc.c, global.now)>
		<cfset loc.e = global.controller.timeAgoInWords(argumentCollection=loc.args)>
	...
	<cffunction name="test_without_seconds_below_45_minutes">
		<cfset loc.args.includeSeconds = false>
		<cfset loc.c = 45 - 1>
		<cfset loc.args.fromTime = dateadd('n', -loc.c, global.now)>
		<cfset loc.e = global.controller.timeAgoInWords(argumentCollection=loc.args)>
