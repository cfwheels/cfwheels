<cfcomponent extends="wheels.test">
	...
	<cffunction name="test_with_seconds_below_5_seconds">
		...
		<cfset loc.e = variables.controller.distanceOfTimeInWords(argumentcollection=loc.a)>
	...
	<cffunction name="test_with_seconds_below_10_seconds">
		...
		<cfset loc.c = 10 - 1>
		<cfset loc.a.toTime = dateadd('s', loc.c, loc.a.fromTime)>
		<cfset halt(false, "variables.controller.distanceOfTimeInWords(argumentcollection=loc.a)")>
		<cfset loc.e = variables.controller.distanceOfTimeInWords(argumentcollection=loc.a)>
