<cfcomponent extends="wheelsMapping.test">
	...
	<cffunction name="test_dateselect_year_is_less_than_startyear">
		...
		<cfset halt(false, "loc.controller.dateSelect(argumentcollection=loc.args)")>
		<cfset loc.e = '<select id="ModelUsers1-birthday-year" name="ModelUsers1[birthday]($year)"><option selected="selected" value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option></select>'>
		<cfset loc.r = loc.controller.dateSelect(argumentcollection=loc.args)>
		<cfset assert("loc.e eq loc.r")>
	</cffunction>
	...
	<cffunction name="dateSelect_year_str">
		<cfargument name="property" type="string" required="true">
		<cfreturn '<select id="ModelUsers1-#arguments.property#-year" name="ModelUsers1[#arguments.property#]($year)"><option value="1973">1973</option><option value="1974">1974</option><option selected="selected" value="1975">1975</option><option value="1976">1976</option></select>'>
	</cffunction>
