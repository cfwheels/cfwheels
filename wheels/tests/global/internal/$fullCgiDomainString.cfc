component extends="wheels.tests.Test" {
	...
	function Test_get_Full_Domain_String_From_CGI_https_non_standard() {
		r = $fullCgiDomainString({server_name = "www.cfwheels.com", server_port = 8443, server_port_secure = 1});
		assert("r EQ 'https://www.cfwheels.com:8443'");
	}
	function Test_get_Full_Domain_String_From_CGI_https() {
		r = $fullCgiDomainString({server_name = "www.cfwheels.com", server_port = 443, server_port_secure = 1});
		assert("r EQ 'https://www.cfwheels.com:443'");
	}
	function Test_get_Full_Domain_String_From_CGI_http() {
		r = $fullCgiDomainString({server_name = "www.cfwheels.com", server_port = 80, server_port_secure = 0});
		assert("r EQ 'http://www.cfwheels.com:80'");
	}
	function Test_get_Full_Domain_String_From_CGI_http_non_standard() {
		r = $fullCgiDomainString({server_name = "www.cfwheels.com", server_port = 8080, server_port_secure = 0});
