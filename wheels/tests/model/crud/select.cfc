<cfcomponent extends="wheelsMapping.Test">
	...
	<cffunction name="test_association_with_expanded_aliases_disabled">
		...
		<cfset assert('loc.columnList eq "(posts.id) AS postprimary_key_id,authors.firstname,authors.id,authors.lastname,posts.authorid,posts.averagerating,posts.body,posts.createdat,posts.deletedat,posts.id AS postid,posts.title,posts.updatedat,posts.views"')>
	</cffunction>
