<cfcomponent extends="wheelsMapping.Test">
	...
	<cffunction name="test_set_include_once">
		...
		<cfset assert('loc.authorModel.query().include eq $listClean(loc.include)')>
	</cffunction>
	...
	<cffunction name="test_set_include_multiple_times">
		...
		<cfset assert('loc.authorModel.query().include eq $listClean(ListAppend(loc.include1, loc.include2))')>
	</cffunction>
