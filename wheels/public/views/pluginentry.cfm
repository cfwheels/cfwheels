...
<div class="ui menu">
	...
	<i class="arrow alternate circle left icon"></i> Back to Plugin List</a>
</div>

<cfif structCount(meta.boxjson)>
	<cfif structKeyExists(meta.boxjson, "homepage")>
		<a class="ui button small teal" href="#meta.boxjson.homepage#" target="_blank"><i class="icon home"></i> www</a>
	</cfif>
