...
<cffunction name="$loadPlugins" returntype="void" access="public" output="false">
	...
	application.wheels.mixableComponents = "application,dispatch,controller,model,cache,base,connection,microsoftsqlserver,mysql,oracle,postgresql,h2,microsoftaccess";
