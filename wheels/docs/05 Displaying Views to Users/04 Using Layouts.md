...
If you don't want for a given template to be wrapped by a layout at all, you may want to consider creating the page as a _partial_. See the chapter about [Partials][1] for more information.
...
Besides having layouts for view pages in Wheels you can also have them on emails that you send out and partial files that you include. We have chosen to speak about these in their respective chapters though: [Sending Email][2] and [Partials][1].

[1]: Partials.md
[2]: Sending%20Email.md