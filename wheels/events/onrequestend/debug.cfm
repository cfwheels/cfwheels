	...
	<table>
		...
		<tr>
			...
			<td>CFWheels #get("version")#
				<cfif loc.hasFrameworkTests> [<a href="#get('webPath')##ListLast(request.cgi.script_name, '/')#?controller=wheels&action=wheels&view=tests&type=core&reload=true">Run Tests</a>]</cfif>
			</td>
		</tr>
		<tr>
