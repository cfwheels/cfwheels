...
<cfif IsDefined("application.wheels.rewriteFile")>
	<p><strong>URL:</strong><br />http://#cgi.server_name##Replace(cgi.script_name, "/#application.wheels.rewriteFile#", "")##cgi.path_info#<cfif cgi.query_string IS NOT "">?#cgi.query_string#</cfif></p>
</cfif>
...
<cfloop list="#loc.scopes#" index="loc.i">
	...
	<cfif NOT ListFindNoCase(loc.skip, loc.scopeName) AND IsDefined(loc.scopeName) AND IsStruct(loc.scopeName)>
		...
		<h2>#loc.scopeName#</h2>
		<cfdump var="#loc.scopeCopy#" format="text" showUDFs="false">
	</cfif>
</cfloop>
</cfoutput>