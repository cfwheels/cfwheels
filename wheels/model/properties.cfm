...
* @sql A SQL expression to use to calculate the property value.
...
*
* @save Argument to decide whether save the property after it has been toggled. Defaults to true.
*/
