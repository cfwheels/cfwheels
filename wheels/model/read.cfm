 ...
 * @returnAs Set to `objects` to return an array of objects, set to `structs` to return an array of structs, or set to `query` to return a query result set. Set to 'sql' to return the executed SQL query as a string.
