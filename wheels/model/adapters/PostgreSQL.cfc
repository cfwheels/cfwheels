<cfcomponent extends="Base" output="false">
	...
	<cffunction name="$getType" returntype="string" access="public" output="false">
		...
		<cfscript>
			...
			{
				case "bigint": case "int8": case "bigserial": case "serial8": {loc.rv = "cf_sql_bigint"; break;}
				case "bool": case "boolean": case "bit": case "varbit": {loc.rv = "cf_sql_bit"; break;}
				case "bytea": {loc.rv = "cf_sql_binary"; break;}
				case "char": case "character": {loc.rv = "cf_sql_char"; break;}
				case "date": case "timestamp": case "timestamptz": {loc.rv = "cf_sql_timestamp"; break;}
				case "decimal": case "double": case "precision": case "float": case "float4": case "float8": {loc.rv = "cf_sql_decimal"; break;}
				case "integer": case "int": case "int4": case "serial": case "oid": {loc.rv = "cf_sql_integer"; break;}  // oid cols should probably be avoided - placed here for completeness
				case "numeric": case "smallmoney": case "money": {loc.rv = "cf_sql_numeric"; break;}  // postgres has deprecated the money type: http://www.postgresql.org/docs/8.1/static/datatype-money.html
				case "real": {loc.rv = "cf_sql_real"; break;}
				case "smallint": case "int2": {loc.rv = "cf_sql_smallint"; break;}
				case "text": {loc.rv = "cf_sql_longvarchar"; break;}
				case "time": case "timetz": {loc.rv = "cf_sql_time"; break;}
				case "varchar": case "varying": case "bpchar": case "uuid": {loc.rv = "cf_sql_varchar"; break;}
			}
		</cfscript>
		<cfreturn loc.rv>
	</cffunction>
