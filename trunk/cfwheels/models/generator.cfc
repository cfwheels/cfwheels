<cfcomponent displayname="Code Generator" hint="Generates model code">
	...
	<cffunction name="init" access="public" output="false" hint="Updates the model schema of the database if needed">
		...
		<cfset fileName = expandPath("#application.filePathTo.models#/#variables.model._name#.cfc")>
		...
		<cfif NOT isDefined('application.wheels.models.#variables.model._name#') OR evaluate("application.wheels.models.#variables.model._name#.hash") IS NOT theHash>
			...
			<cfif arrayLen(initFind.pos) GT 1>
				...
				<cfset relationships = readInit(modelFile, "hasMany,belongsTo,hasOne,hasAndBelongsToMany", "name,modelName,foreignKey,joinTableName,order,conditions")>
				...
				<!--- Generate the code --->
				<cfset generateCode(relationships, validations, finders)>
				...
				<cfset "application.wheels.models.#variables.model._name#.hash" = theHash>
	...
	<cffunction name="assembleCode" access="private" returntype="void" output="false" hint="Assembles all of the code for the model">
		...
		<cfloop from="1" to="#arrayLen(arguments.generatedCode)#" index="i">
			<cfif arguments.generatedCode[i].type IS "relationship">
...
<cgcomponent displayname="_#variables.model._name#" extends="cfwheels.models._model" hint="Creates a 'dao' type of model for single-record models">
	...
	<cgfunction name="validateOnUpdate" access="public" output="false" returntype="void" hint="Validates the model against some rules, only for existing records">
		...
		<cfset fileName = "_#variables.model._name#.cfc">
	...
	<cffunction name="codeCollector" access="private" output="true" hint="Populates a struct full of generated code to save">
		<cfargument name="type" type="string" required="true" hint="The type of code this is (relationship|validation)">
	...
	<cgfunction name="#arguments.name#" access="public" returntype="any">
		...
		<cgif NOT isObject(this._#arguments.name#) OR arguments.forceReload>
			<cgset this._#arguments.name# = application.core.model("#arguments.modelName#").findAll(where="#arguments.foreignKey#=##this.id##")>
		</cgif>
	...
	<cgfunction name="add#arguments.modelName#" access="public" returntype="any">
		<cgargument name="object" type="any" required="yes">
		<cgset var objArray = arrayNew(1)>
		<cgif isArray(arguments.object)>
			<cgset objArray = arguments.object>		
	...
	<cgfunction name="delete#arguments.modelName#" access="public" returntype="any">
		<cgargument name="object" type="any" required="yes">
		<cgset var objArray = arrayNew(1)>
		<cgif isArray(arguments.object)>
			<cgset objArray = arguments.object>		
	...
	<cgfunction name="#arguments.name#RecordFound" access="public" returntype="boolean">
		<cgif this.#arguments.name#RecordCount() IS 0>
			<cgreturn true>
		<cgelse>
			<cgreturn false>
		</cgif>
	...
	<cgfunction name="#arguments.name#RecordCount" access="public" returntype="numeric">
		<cgreturn application.core.model("#arguments.modelName#").count(where="#arguments.foreignKey# = ##this.id##")>
	</cgfunction>

	<cgfunction name="find#arguments.modelName#" access="public" returntype="any">
	...
	<cffunction name="hasAndBelongsToMany" access="private" output="false" hint="Outputs some generated code for hasAndBelongsToMany relationships">
		...
		<cfargument name="modelName" type="string" required="no" default="#arguments.name#">
		<cfargument name="foreignKey" type="string" required="no" default="#application.core.singularize(variables.model._tableName)#_id">
		<cfargument name="associationForeignKey" type="string" required="no" default="#application.core.singularize(arguments.modelName)#_id">
		<cfargument name="joinTable" type="string" required="no" default="#application.core.joinTableName(variables.model._tableName, arguments.modelName)#">
		<cfargument name="order" type="string" required="no" default="">
		<cfargument name="conditions" type="string" required="no" default="">
	...
	<cgfunction name="#arguments.name#" access="public" returntype="any">
		<cgargument name="forceReload" type="boolean" required="no" default="false">
		<cgif NOT isObject(this._#arguments.name#) OR arguments.forceReload>
			<cgset this._#arguments.name# = application.core.model("#application.core.singularize(arguments.modelName)#").findAllBySQL("SELECT #arguments.modelName#.* FROM #arguments.modelName# INNER JOIN #arguments.joinTable# ON #arguments.modelName#.id = #arguments.joinTable#.#arguments.associationForeignKey# WHERE #arguments.joinTable#.#arguments.foreignKey# = ##this.id##")>
		</cgif>
		<cgreturn this._#arguments.name#>
	</cgfunction>
	...
	<cgfunction name="set#arguments.name#" access="public" returntype="any">
		...
		<cgloop from="1" to="##arrayLen(objArray)##" index="i">
			<cgset application.core.executeSQL("INSERT INTO #arguments.joinTable# (#arguments.foreignKey#, #arguments.associationForeignKey#) VALUES (##this.id##, ##objArray[i].id##)")>
		</cgloop>	
		<cgreturn this.#arguments.name#(forceReload=true)>
	</cgfunction>
	...
	<cgfunction name="delete#application.core.singularize(arguments.modelName)#" access="public" returntype="any">
		...
		<cgloop from="1" to="##arrayLen(objArray)##" index="i">
			<cgset application.core.executeSQL("DELETE FROM #arguments.joinTable# WHERE #arguments.associationForeignKey# = ##objArray[i].id##")>
		</cgloop>	
		<cgreturn this.#arguments.name#(forceReload=true)>
	</cgfunction>

	<cgfunction name="clear#arguments.name#" access="public" returntype="any">
			<cgset application.core.executeSQL("DELETE FROM #arguments.joinTable# WHERE #arguments.foreignKey# = ##this.id##")>
		<cgreturn this.#arguments.name#(forceReload=true)>
	</cgfunction>
	...
	<cgfunction name="#arguments.name#RecordCount" access="public" returntype="numeric">
		<cgset application.core.executeSQL("SELECT COUNT(*) AS total FROM #arguments.joinTable# WHERE #arguments.foreignKey# = ##this.id##").total>
	</cgfunction>
	...
	<cgfunction name="#arguments.name#" access="public" returntype="any">
		<cgargument name="forceReload" type="boolean" required="no" default="false">
		<cgif NOT isObject(this._#arguments.name#) OR arguments.forceReload>
			<cgset this._#arguments.name# = application.core.model("#arguments.modelName#").findOne(where="#arguments.foreignKey#=##this.id##")>
		</cgif>
		<cgreturn this._#arguments.name#>
	</cgfunction>
